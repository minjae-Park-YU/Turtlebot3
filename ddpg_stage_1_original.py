#!/home/park/anaconda3/envs/mytorch/bin/python3
...
class Trainer:
    ...
    def optimizer(self):
        ...
        writer.add_scalar("loss_actor", loss_actor)
...
if __name__ == '__main__':
    ...
    for ep in range(MAX_EPISODES):
        ...
        reward_list.append(rewards_current_episode)
        if ep % 20 == 0:
            trainer.save_models(ep)
        if ep % 10 == 0:
            df_name = "reward_ep" + str(ep) + ".csv"
            print("data saving...")
            df1 = pd.DataFrame(reward_list, columns=['reward'])
            df1.to_csv("/home/park/catkin_ws/src/turtlebot3_ddpg/src/" + df_name)
