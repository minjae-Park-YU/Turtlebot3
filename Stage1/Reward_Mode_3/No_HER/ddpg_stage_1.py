...
class Trainer:
    ...
    def optimizer(self):
        ...
        print("***** actor loss : ", loss_actor, " critic_loss : ", loss_critic)
...
def newReward(prev_cord, cord, step, reward_mode):  # for HER
	...
	# (22.07.22) reward mode 에 상관없이 아래 조건문이 사용되므로 조건문 밖에서 한 번만 실행하는 것으로 변경
    ...
    for ensemble in range(10):
        ...
        for ep in range(MAX_EPISODES):
            ...
            for step in range(MAX_STEPS):
                ...
                #setHER(temp_list, 100, reward_mode)
                #setHER(temp_list, 250, reward_mode)
                #setHER(temp_list, 400, reward_mode)
            ...
            if ep % 100 == 0:
                ...
                df1.to_csv("/home/park/catkin_ws/src/turtlebot3_ddpg/src/Rewards/" + df_name)
                df2.to_csv("/home/park/catkin_ws/src/turtlebot3_ddpg/src/Rewards/" + df1_name)
