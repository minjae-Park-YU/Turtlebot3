...
class Env():
    ...
    def setReward(self, state, done):
        ...
        min_LDS1, min_LDS2 = sorted_LDS_values[0], sorted_LDS_values[1]
        obstacle_penalty = np.mean([10*np.log(min_LDS1), 10*np.log(min_LDS2)]) 
        # heading = state[-2]
        ...
        #print("reward:", reward)
        #print("obstacle reward:", obstacle_penalty)
        
        reward += obstacle_penalty

        #print("step per reward:", reward)
