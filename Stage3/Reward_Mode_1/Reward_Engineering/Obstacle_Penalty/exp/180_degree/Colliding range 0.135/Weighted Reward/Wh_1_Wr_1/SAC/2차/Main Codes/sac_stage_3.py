...
def save_models(episode_count):
    ...
    torch.save(value_net.state_dict(), dirPath + '/SAC_Models/' + world + '/' +  str(ensemble) + '/'+ str(episode_count)+ '_value_net.pth')
    torch.save(soft_q_net.state_dict(), dirPath + '/SAC_Models/' + world + '/' +  str(ensemble) + '/'+ str(episode_count)+ '_soft_q_net.pth')
    torch.save(target_value_net.state_dict(), dirPath + '/SAC_Models/' + world + '/'+  str(ensemble) + '/' + str(episode_count)+ '_target_value_net.pth')
    print("====================================")
